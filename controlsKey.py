...
class controlsKey(object):
    def __init__(self, font1, font2, controlkey, text):
        self.font1 = font1
        self.font2 = font2
        self.key = controlkey
        self.text = text
    ...
    def key_display(self):
        ...
        pygame.draw.rect(self.KEYSURF, self.bgcolor, Rect((self.surfheight//10, self.surfheight//10), (self.surfheight - (self.surfheight//10), self.surfheight - (self.surfheight//10))
